      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-6 overflow-x-auto">
          {orders.map((order) => (
            <div
              key={order.id}
              className="bg-white rounded shadow p-6 flex flex-col md:flex-row md:justify-between md:items-start space-y-4 md:space-y-0 md:space-x-6"
            >
              {/* Customer Info */}
              <div className="flex-1 min-w-[200px]">
                ...
                <p>
                  <span className="font-semibold">Comments:</span> {order.comments || "None"}
                </p>
                <p>
              ...
              {/* Status & Actions */}
              <div className="flex flex-col space-y-2 flex-shrink-0 min-w-[150px]">
                <p className="font-semibold">Status: {order.status}</p>
