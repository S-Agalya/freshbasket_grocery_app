...
import { FaPlus, FaMinus, FaChevronLeft, FaChevronRight, FaMapMarkerAlt, FaBolt, FaRobot, FaArrowRight } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-32 md:pb-10">
      ...
      <main className="max-w-screen-xl mx-auto px-4 md:px-8 py-4">
        ...
        <button
          onClick={() => window.dispatchEvent(new Event("freshbasket-open-assistant"))}
          className="mb-6 w-full rounded-[24px] border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-lime-50 p-4 text-left shadow-[0_12px_35px_rgba(16,185,129,0.08)] transition hover:translate-y-[-1px] hover:shadow-[0_16px_40px_rgba(16,185,129,0.12)]"
        >
          <div className="flex items-start justify-between gap-3">
            <div className="flex-1">
              ...
              <h2 className="mt-2 text-base font-bold text-gray-900">Need help shopping?</h2>
              <p className="mt-1 text-sm text-gray-600">Tap here to open the assistant and add, remove, or suggest items in seconds.</p>
            </div>
