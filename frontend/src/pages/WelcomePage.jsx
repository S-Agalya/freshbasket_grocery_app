  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 via-yellow-50 to-blue-50">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <button
          className="absolute top-4 left-4 z-20 md:hidden bg-green-700 text-white p-2 rounded-lg"
        ...
        {/* CAROUSEL */}
        <main className="flex-1 flex flex-col items-center justify-center px-4 md:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 w-full max-w-5xl mx-auto">
            {/* For mobile: vertical arrows */}
            <button
              onClick={goPrev}
              className="md:hidden bg-green-700 hover:bg-green-800 text-white rounded-full shadow-lg flex items-center justify-center w-12 md:w-16 aspect-square text-2xl md:text-3xl transition"
            >
              ↑
            </button>
            ...
            <img
              src={images[slide]}
              alt={titles[slide]}
              className="flex-1 w-full max-h-80 md:max-h-96 object-contain rounded-3xl shadow-xl border"
            />
            ...
            {/* For mobile: down button */}
            <button
              onClick={goNext}
              className="md:hidden bg-green-700 hover:bg-green-800 text-white rounded-full shadow-lg flex items-center justify-center w-12 md:w-16 aspect-square text-2xl md:text-3xl transition mt-4"
            >
              ↓
            </button>
          </div>

          <h3 className="text-2xl font-semibold mt-6 text-green-700">
            {titles[slide]}
          </h3>
