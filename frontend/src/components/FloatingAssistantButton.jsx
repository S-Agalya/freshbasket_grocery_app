  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 md:bottom-8 right-3 sm:right-4 md:right-8 z-45 flex items-center gap-2 rounded-full border border-emerald-200 bg-gradient-to-r from-emerald-600 via-green-600 to-lime-500 px-3 py-3 text-white shadow-[0_18px_40px_rgba(16,185,129,0.26)] transition hover:-translate-y-0.5 hover:scale-[1.02] active:scale-[0.98]"
